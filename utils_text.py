...
# Author  :
"""
follow: SemStyle: Learning to Generate Stylised Image
        Captions using Unaligned Text
"""
...
def tokenize_text(text, vsize=10000, res=Toks.TOTAL_RES, unk_idx=Toks.UNK,
                  lower_case=False, word_to_idx=None, idx_to_word=None):
    tt = []
    tc = Counter()
    for line in text:
